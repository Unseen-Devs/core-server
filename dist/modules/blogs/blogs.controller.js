...
let BlogsController = class BlogsController {
    constructor(blogService, audioService) {
...
], BlogsController.prototype, "find", null);
__decorate([
    (0, common_1.Post)('transcode'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BlogsController.prototype, "transcode", null);
BlogsController = __decorate([
    (0, common_1.Controller)('blogs'),
    __metadata("design:paramtypes", [blogs_service_1.BlogsService, audio_service_1.AudioService])
], BlogsController);
